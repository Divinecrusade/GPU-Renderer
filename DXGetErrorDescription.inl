...
UINT const icount = static_cast<UINT>( std::min<size_t>( count, 32767 ) );

DWORD const result = DX_FORMATMESSAGE( FORMAT_MESSAGE_FROM_SYSTEM, nullptr, gsl::narrow_cast<DWORD>(hr),
...
// -------------------------------------------------------------
    default: OutputDebugString(TEXT("Unknown error\n")); break;
}
