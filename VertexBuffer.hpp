...
class VertexBuffer : public Graphics::Bindable {
 ...
 public:
  template <typename T>
  VertexBuffer(gsl::span<T const> vertices)
      : Bindable{},
        ...
        vertex_buffer_desc_{
            ...
            .MiscFlags = kNoMisc},
        vertex_buffer_subres_{.pSysMem = vertices.data()} {}
  ...
  void Bind(Graphics& gfx) override {
    ...
    if (HRESULT const operation_status = GetDevice(gfx).CreateBuffer(
            &vertex_buffer_desc_, &vertex_buffer_subres_, &vertex_buffer_);
 ...
 private:
  ...
  D3D11_SUBRESOURCE_DATA vertex_buffer_subres_;
